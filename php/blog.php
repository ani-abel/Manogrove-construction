...
<head>
    <meta charset="utf-8">
    <title>Blog : Catch the latest updates on our activites | Manogrove Construction</title>
    ...
    <style>
        .main-header-2
        {
            ...
            background: url("../images/site-images/aged-1846818_1920.jpg") !important;
...
<section class="hide-section main-header-2 showcase z-depth-5" style="height: 25vh;">
    <div class="row">
        <div class="col s12 m10 main-text" style="padding: 50px 20px 20px 30px;">
            <h4 class="text-capitalize">BLOG</h4>
            <p class="enlarge-p grey-text text-lighten-2">
                Catch the latest updates on our projects
            </p>
        </div>
    </div>
</section>
...
<section class="hide-section container section-intro">
    <div class="row">
        ...
        <div class="col s12 m6">
            <div class="card white rounded-10px">
                <div class="card-image">
                    ...
                    <a href="blog_single.php?post_id=<?php echo base64_encode($value["post_id"]); ?>"
                       class="btn-floating btn-large halfway-fab waves-effect waves-ripple blue">
                        <i class="fa fa-plus"></i>
                    </a>
                </div>
                <div class="card-content center">
                    <span class="card-title text-capitalize"><?php echo $value["post_title"]; ?></span>
        ...
        <div class="col s12 center red-text text-darken-3">
            <i class="fa-5x fa fa-newspaper-o"></i>
            <p class="flow-text">No posts found</p>
        </div>
        <?php } ?>
    </div>
</section>
